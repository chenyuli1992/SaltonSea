...
awk '{print $5,$3*100}' pgv_dist_lp1.dat | \
psxy -R10/30000/0.01/8 -JX6l/5.5l -Ba1f3p:"Distance (km)":\
...
#psxy -R -JX -SC0.12 -W1p/black -G255/0/255 -O -P -K >> $outmap
psxy -R -JX -SC0.12 -W1p/black -Gred -O -P -K >> $outmap

awk '{if ( NR==28 || NR==30 || NR==34 || NR==35) print $5,$3*100}' pgv_dist_lp1.dat | \
psxy -R -JX -SC0.12 -W1p/black -Ggreen -O -P -K >> $outmap

#awk '{print $5,$3*100*1.08, "12 0 0 CB "substr($1,1,8)+1}' pgv_dist_lp1.dat > text_pgv.txt
pstext  -R -JX -P -O -K text_pgv.txt >> $outmap
echo "15 7.5 14 0 0 CT (a)" | pstext -R -JX -P -O -K >> $outmap
...
echo 1 1 | psxy -R10/30000/1/800 -JX6l/5.5l -Ba1f3:"":/a1f3:"Dynamic Stress(kpa)":E -Sc0.01 -P -O -K >> $outmap
#legend
pslegend -Dx0.1/0.1/1.7/0.70/BL -JX -R -F -K -O << EOF >> $outmap
S 0.15 c 0.10 red 1p/black 0.6c In study period 
S 0.15 c 0.10 green 1p/black 0.6c Beyond study period 
